...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/hey-d
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/hey-d-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using hey-d:subagent-driven-development. The plan is at: $PLAN_PATH"
