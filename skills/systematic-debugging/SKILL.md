...
1. **Create Failing Test Case**
   ...
   - Use the `hey-d:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **hey-d:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **hey-d:verification-before-completion** - Verify fix worked before claiming success
